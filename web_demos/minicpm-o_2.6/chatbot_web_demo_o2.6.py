...
# Monkey-patch gradio_client's JSON schema conversion function to avoid iterating booleans.
original_json_schema_to_python_type = gutils._json_schema_to_python_type
def patched_json_schema_to_python_type(schema, defs=None):
    if not isinstance(schema, dict):
        return str(schema)
    return original_json_schema_to_python_type(schema, defs)
gutils._json_schema_to_python_type = patched_json_schema_to_python_type
